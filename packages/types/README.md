...
<a href="https://www.npmjs.com/package/@cloudinary-util/types"><img alt="npm" src="https://img.shields.io/npm/v/@cloudinary-util/types?style=flat-square"></a> <a href="https://github.com/colbyfayock/cloudinary-util/blob/main/LICENSE"><img alt="GitHub" src="https://img.shields.io/github/license/colbyfayock/cloudinary-util?label=License&style=flat-square"></a>
...
```
npm install @cloudinary-util/types
```
